...
Route::group(['middleware' => ['auth']], function() {
  ...
  Route::resource('sapis', 'SapiController');

  Route::resource('experts.sapiSubs', 'SapiSubController');
  Route::resource('sapiSubs', 'SapiSubController');
  ...
  Route::delete('/destroyAllPSubsByExpertId/{expert_id}', ['uses'=>'SapiSubController@destroyAllByExpertId', 'as'=>'dPSub']);
